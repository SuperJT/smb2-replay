...
def test_setup_with_pcap():
    ...
    try:
        ...
        try:
            ...
            # Write some data
            test_data = f"Test data written at {timestamp}".encode('utf-8')
        ...
        try:
            ...
            # Write some data
            test_data = f"Root test data written at {timestamp}".encode('utf-8')
        ...
        print(f"💡 Analyze the PCAP to see what SMB operations were actually performed")

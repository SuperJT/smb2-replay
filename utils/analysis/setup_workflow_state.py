...
def setup_file_system_state(
    analysis: dict[str, Any], dry_run: bool = False
) -> dict[str, Any]:
    ...
    print("Setting up file system state for replay...")
...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        print(
            "Example: python setup_workflow_state.py smb2_session_0x9dbc000000000006.parquet"
        )
        sys.exit(1)

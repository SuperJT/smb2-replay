...
def compare_requests(
    original_request: dict[str, Any], replayed_request: dict[str, Any]
) -> dict[str, Any]:
...
def main():
    ...
    if len(sys.argv) != 2:
        ...
        print(
            "Example: python analyze_response_mismatches.py smb2_session_0x9dbc000000000006.parquet"
        )
        sys.exit(1)
    ...
    mismatched_ops = [
        op for op in validation_results["details"] if not op["status_match"]
    ]
    ...
    for status_pair, count in sorted(

...
benchmark_step("7. os.path.expanduser('~/cases')", lambda: os.path.expanduser('~/cases'))
benchmark_step("8. os.path.expanduser('~/.config/smbreplay')", lambda: os.path.expanduser('~/.config/smbreplay'))

# Test file system operations
benchmark_step("9. os.path.exists('~/.config')", lambda: os.path.exists(os.path.expanduser('~/.config')))
benchmark_step("10. os.path.exists('~/cases')", lambda: os.path.exists(os.path.expanduser('~/cases')))

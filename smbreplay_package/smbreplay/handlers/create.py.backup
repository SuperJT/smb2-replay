...
def handle_create(self, tree, op: Dict[str, Any], all_operations: Optional[List[Dict[str, Any]]] = None):
    ...
    if all_operations:
        create_type, open_action = self.determine_create_type_and_action(op, all_operations)
